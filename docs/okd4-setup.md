...
На кластерах, обслуживающих реальные нагрузки рекомендуется выносить системные компоненты, такие как 
...
Такой подход удовлетворяет потребности по стабильности и производительности, но понижает скалирование и выживаемость компонентов, 
